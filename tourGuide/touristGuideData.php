          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1" href="./profileGuide.php" role="tab" aria-selected="false">
                ...
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 active" href="./touristGuideData.php?id=<?php echo $id_persona; ?>" role="tab" aria-selected="true">
...
?>
    <script>
      Swal.fire({
        ...
        window.location = "./profileGuide.php";
      });
    </script>
  <?php
  } else {
