...
$consulta_guia = mysqli_query($con, "SELECT persona.id_persona FROM persona WHERE persona.correo_persona = '$correo_persona'");
$resultado = mysqli_fetch_array($consulta_guia);

$consultabuscar = mysqli_query($con, "SELECT * FROM persona JOIN guia_turistico ON persona.id_persona = guia_turistico.id_persona WHERE guia_turistico.id_persona=$resultado[0]");
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="./profileGuide.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Mi cuenta</li>
          </ol>
          <h6 class="text-white font-weight-bolder ms-2">Mi cuenta</h6>
        </nav>
        <div class="collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2" id="navbar">
          ...
          <ul class="navbar-nav justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-white btn-sm mb-0 me-3" href="">Buscar</a>
            </li>
          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 " href="./touristGuideData.php?id=<?php echo $id_persona; ?>" role="tab" aria-selected="false">
              ...
              <div class="card-header pb-0 p-3">
                <div class="row">
                  ...
                  <div class="col-md-4 text-end">
                    <a href="./touristGuideData.php?id=<?php echo $id_persona; ?>">
              ...
              <div class="card-header pb-0 p-3">
                <div class="row">
                  ...
                  <div class="col-6 text-end">
                    <a class="btn bg-gradient-primary mb-0" href="./SentenceEliminateTourGuide.php?id_persona=<?php echo $id_persona; ?>">Darte de baja</a>
                  </div>
                </div>
              </div>
              <div class="card-body p-3">
