      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Actualizar actividades</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Actualizar actividades</h6>
        </nav>
                    ...
                    <div class="card card-blog card-plain">
                      ...
                      <div class="card-body px-1 pb-0">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                          <a href="./activityUpdateForm.php?id_actividad=<?php echo $dato['id_actividad'] ?>" class="btn btn-outline-primary btn-sm mb-0">Actualizar Actividad</a>
                        </div>
                      </div>
                    </div>
                  </div>
