...
$consultabuscar = mysqli_query(conexion(), "SELECT * FROM persona JOIN turista ON persona.id_persona = turista.id_persona WHERE turista.id_persona=$id ");
          ...
          <div class="col-12 mt-4">
            <div class="card mb-4">
              <div class="card-header pb-0 p-3">
                <h6 class="mb-1">Turísta</h6>
                <p class="text-sm">Información</p>
              </div>
