            ...
            <div class="card-header pb-0 p-3 ">
              <div class="row">
                ...
                <div class="col-6 text-end">
                  <a class="btn btn-sm bg-gradient-primary" href="./administratorRegistrationForm.php" style="border-radius: 50px;"><i class="fas fa-plus"></i>&nbsp;&nbsp;Registrar</a>
                </div>
              </div>
            </div>
              ...
              <div class="table-responsive p-0 py-3">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $sql = ("SELECT * FROM persona JOIN administrador WHERE persona.id_persona = administrador.id_persona");
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="./viewAdministratorInformation.php?id=<?php echo $id_persona; ?>" class="text-success font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"> <i class="far fa-regular fa-eye me-2"></i>
                            Visualizar
                          </a>
                        </td>
