...
<head>
  ...
  <title>
    Administrar actividades turísticas
  </title>
                      ...
                      <div class="card card-blog card-plain">
                        ...
                        <div class="card-body px-1 pb-0">
                          ...
                          <div class="ms-auto text-center">
                            <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="./SentenceEliminateActivity.php?id_actividad=<?php echo $dato['id_actividad'] ?>"><i class="far fa-trash-alt me-2"></i>Eliminar</a>
                            <a class="btn btn-link text-success px-3 mb-0" href="./viewActivity.php?id_actividad=<?php echo $dato['id_actividad'] ?>"><i class="far fa-regular fa-eye me-2"></i>Visualizar</a>
                          </div>
                        </div>
                      </div>
                    </div>
