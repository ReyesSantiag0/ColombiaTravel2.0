...
$consultabuscar = mysqli_query(conexion(), "SELECT * FROM persona JOIN administrador ON persona.id_persona = administrador.id_persona WHERE administrador.id_persona=$id");
...
if (isset($_POST['btnmodificar'])) {
  ...
  $especialidad_administrador_update = $_POST['especialidad_administrador'];
  ...
  $querymodificar_administrador = mysqli_query(
    ...
    "UPDATE administrador 
      SET especialidad_administrador = '$especialidad_administrador_update'
      WHERE id_persona = $id"
  );
  ...
  ?>
    <script>
      Swal.fire({
        ...
        window.location = "./administratorData.php";
      });
    </script>
<?php
  }
