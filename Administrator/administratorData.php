          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 active " href="./profileAdministrator.php" role="tab" aria-selected="true">
                ...
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 " href="./administratorData.php?id=<?php echo $id_persona; ?>" role="tab" aria-selected="false">
                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body p-3">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="" id="especialidad_administrador" name="especialidad_administrador" value="<?php echo $especialidad_administrador; ?>">
                        </div>
                        <div class="form-group">
...
if (isset($_POST['btnmodificar'])) {
  ...
  $querymodificar_administrador = mysqli_query(
    conexion(),
    "UPDATE administrador 
      SET especialidad_administrador = '$especialidad_administrador'
      WHERE id_persona = $id"
  );

  if ($querymodificar_administrador) {
?>
    <script>
      Swal.fire({
        icon: 'success',
        ...
        window.location = "./profileAdministrator.php";
      });
    </script>
  <?php
  } else {
