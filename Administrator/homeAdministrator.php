    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Guías turísticos</h6>
        </nav>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $sql = ("SELECT * FROM persona JOIN guia_turistico WHERE persona.id_persona = guia_turistico.id_persona");
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div>
                              <img src="data:image;base64,<?php echo base64_encode($foto_persona);  ?>" class="avatar avatar-sm me-3" alt="img guia">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                        ...
                        <td>
                          <a href="./viewGuideInformation.php?id=<?php echo $id_persona; ?>" class="text-success font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"> <i class="far fa-regular fa-eye me-2"></i>
                            Visualizar
                          </a>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <a href="./viewTouristActivities.php?id=<?php echo $id_persona; ?>" class="text-success font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"> <i class="far fa-regular fa-eye me-2"></i>
                            Visualizar
                          </a>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <a href="./SentenceEliminateGuide.php?id_guia=<?php echo $dato['id_persona'] ?>" class="text-danger font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"> <i class="far fa-trash-alt me-2"></i>
                            Eliminar
                          </a>
                        </td>
                      </tr>
