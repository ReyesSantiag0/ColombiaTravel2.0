              ...
              <div class="card-body p-3">
                <div class="row">
                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body p-3">
                        <div class="form-group">
                          <label>Nombres</label>
                          <input type="text" class="form-control" placeholder="" id="nombre_persona" name="nombre_persona">
                        </div>
                        <div class="form-group">
                          <label>Apellidos</label>
                          <input type="text" class="form-control" placeholder="" id="apellido_persona" name="apellido_persona">
                        </div>
                        <div class=" form-group">
                          <label>Edad</label>
                          <input type="text" class="form-control" placeholder="" id="edad_persona" name="edad_persona">
                        </div>
                        <div class="form-group">
                          <label>Género</label>
                        ...
                        <div class="form-group">
                          ...
                          <input type="" class="form-control" placeholder="" id="telefono_persona" name="telefono_persona">
                        </div>
                        <div class="form-group">
                          <label>Correo</label>
                          <input type="email" class="form-control" placeholder="" id="correo_persona" name="correo_persona">
                        </div>
                        <div class="form-group">
                          <label>Especialidad</label>
                          <input type="text" class="form-control" placeholder="" id="especialidad_administrador" name="especialidad_administrador">
                        </div>
                        <div class="form-group">
                          <label>Fotografía</label>
                          <input type="file" class="form-control" placeholder="" id="foto_persona" name="foto_persona">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row d-flex justify-content-center align-items-center h-100">
                    <button class="btn btn-sm bg-gradient-primary mt-3 w-15" type="submit">Registrar</button>
                  </div>
                </div>
              </div>
            </div>
...
if (!empty($_POST)) {
  if (empty($_POST['nombre_persona']) || empty($_POST['apellido_persona']) || empty($_POST['edad_persona']) || empty($_POST['genero_persona']) || empty($_POST['telefono_persona']) || empty($_POST['correo_persona']) || empty($_POST['contrasena_persona']) || empty($_POST['contrasena_persona_check']) || empty($_POST['especialidad_administrador']) || empty($_FILES['foto_persona'])) {
?>
    <script>
      Swal.fire({
        icon: 'error',
    ...
    $especialidad_administrador = $_POST['especialidad_administrador'];
    ...
    $foto_persona_registro = mysqli_escape_string(conexion(), $binariosImagen);
    ...
    ?>
      ...
      ?>
        ...
        $query_insert_client = mysqli_query(conexion(), "INSERT INTO persona (nombre_persona, apellido_persona, edad_persona, genero_persona, telefono_persona, correo_persona, contrasena_persona, foto_persona, id_rol_persona) 
        VALUES ('$nombre_persona','$apellido_persona','$edad_persona','$genero_persona','$telefono_persona', '$correo_persona', '$contrasena_persona', '$foto_persona_registro', 1)");
        ...
        $query_insert_administrador = mysqli_query(conexion(), "INSERT INTO administrador(especialidad_administrador, id_persona) VALUES ('$especialidad_administrador', $result_id[0])");
