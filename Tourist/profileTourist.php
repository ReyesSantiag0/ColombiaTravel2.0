    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Mis actividades turísticas</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link  active" href="./profileTourist.php">
            ...
            <span class="nav-link-text ms-1">Actividades turísticas</span>
          </a>
        </li>
        <li class="nav-item mt-3">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="./touristData.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Turísta</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Turísta</h6>
        </nav>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="./viewGuideInformation.html" class="text-success font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"> <i class="far fa-regular fa-eye me-2"></i>
                          Visualizar
                        </a>
                      </td>
